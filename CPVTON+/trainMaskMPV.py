...
import os
import time
from mpv_dataset import CPDataset, CPDataLoader
from networks import GMMMaskMPV, GicLoss, GMM, UnetGenerator, VGGLoss, load_checkpoint, save_checkpoint
...
def get_opt():
    ...
    parser.add_argument("--dataroot", default="data/MPV")
    parser.add_argument("--datamode", default="train")
    parser.add_argument("--stage", default="GMM")
    # parser.add_argument("--stage", default="TOM")
    parser.add_argument("--data_list", default="all_poseA_poseB_clothes_0607.txt")
...
def train_tom(opt, train_loader, model, board):
    ...
    for step in range(80000, opt.keep_step + opt.decay_step):
        iter_start_time = time.time()
        inputs = train_loader.next_batch()
