...
from networks import GMMMask, GMM, UnetGenerator, load_checkpoint
...
def get_opt():
    ...
    # parser.add_argument("--data_list", default="viton_test_pairs_classified_linux.txt")
    # parser.add_argument("--data_list", default="viton_test_pairs_classified_linux_diff.txt")
