...
import os
import time
from cp_datasetAffineTPS import CPDataset, CPDataLoader
from networks import GMM, AffineGMM, UnetGenerator, load_checkpoint

from tensorboardX import SummaryWriter
from visualization import board_add_image, board_add_images, save_images

#python test.py --name gmm_originaltest_new --stage GMM --workers 4 --datamode test --data_list test_pairs.txt --checkpoint checkpoints/originalGMM/gmm_final.pth
def get_opt():
