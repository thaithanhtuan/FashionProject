...
from networks import GMM, AffineGMM, LAGMM, UnetGenerator, VGGLoss, load_checkpoint, save_checkpoint, GicLoss
...
def train_gmm(opt, train_loader, model, board):
    ...
    for step in range(opt.keep_step + opt.decay_step):
        ...
        if (step+1) % opt.display_count == 0:
            ...
            print('step: %8d, time: %.3f, loss: %4f, 40*gicloss: %.8f, Lwarp: %.6f' % (step+1, t, loss.item(),(40*Lgic).item(),Lwarp.item()), flush=True)
